...
export default {
  ...
  home: {
    title: 'manuscripts.identity.title',
    intro: 'manuscripts.home.intro',
    cards: [
      {
        title: 'manuscripts.nav.catalogue',
        description: 'manuscripts.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'manuscripts.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'manuscripts.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'manuscripts.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'manuscripts.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'manuscripts.partnerObjects.emptyPartner',
  //         emptyInstitution: 'manuscripts.partnerObjects.emptyInstitution',
  //         institutionSummary: 'manuscripts.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'manuscripts.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'manuscripts.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
