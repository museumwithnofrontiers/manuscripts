...
// `useGalleryData.js` used to be byte-identical local copies of what manuscripts
...
// legacy project key, no UUID — manuscripts shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (manuscripts-data 1.0.11+), an outside
