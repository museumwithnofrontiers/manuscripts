...
The **Museum With No Frontiers — Manuscripts** gallery, built from the published
dataset `@museumwnf/manuscripts-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/manuscripts-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/manuscripts/> through the reusable workflows in
